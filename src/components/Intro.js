...
function Intro() {
  return (
      <div className='intro'>
        <div className='disclaimer'>* This is a mock NFT project. It is for display purposes only. The NFTs below can only be purchased with mock matic and can only be displayed on OpenSea's testnet site.</div>
