  ...
  return (
      <div className='about'>
        ...
        <div className='community'>
          ...
          <div className='content'>
            <div className='content-text'>
              <p>Remove your mask and be the delightful ghoul that you are. The Whitsteen Project community is a place where all are welcome, as long as you're a weirdo. Vulgar heresies may be spoken. Smiles are encouraged.</p>
